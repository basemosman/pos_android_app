 ...
 */
public class DeviceListActivityPrint extends Activity {
    // Debugging
    private static final String TAG = "DeviceListActivityPrint";
...
//        });
    ...
    public void findOnePaired(String data){
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // When discovery is finished, change the Activity title
                ...
                setTitle(R.string.Ready_To_Print);
